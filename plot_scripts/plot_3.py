...
for dimension in range(1,7):
    ...
    ends, indices = r.get_ES_count(path, dimension)
    ...
    selection = np.random.choice(simplex_list.shape[0], np.min([10000,simplex_list.shape[0]]), replace = False)
    a1 = []
    a2 = []
    a3 = []
    a4 = []
    ...
    ax.set_title("Extended simplices and sink in-degree dim "+str(dimension+1))
    fig1.savefig("ES-ID"+str(dimension), facecolor="white")
    ...
    ax.set_ylabel("Extended simplices")
    ax.set_title("Extended simplices and sink out-degree dim "+str(dimension+1))
    fig2.savefig("ES-OD"+str(dimension), facecolor = "white")
    ...
    ax.set_ylabel("Extended simplices")
    ax.set_title("Extended simplices and sink degree dim "+str(dimension+1))
    fig3.savefig("ES-D"+str(dimension), facecolor = "white")
    ...
    ax.set_ylabel("Extended simplices")
    ax.set_title("Extended simplices and sink bidegree dim "+str(dimension+1))
    fig4.savefig("ES-BD"+str(dimension), facecolor = "white")
