...
# plot the 2d histogram of morphology of the column.
...
for dimension in range(1,7):
    ...
    ax.set_title("Normalized bisimplex count per mtype on dim "+ str(dimension + 1))
    ax.set_xticklabels(ax.get_xticklabels(), rotation = 45, ha = 'right')
    ...
    ax.set_title("Normalized extended simplex count per mtype on dim "+ str(dimension + 1))
    ax.set_xticklabels(ax.get_xticklabels(), rotation = 45, ha = 'right')
    ...
    ax.set_title("Normalized bisimplex sink counts per mtype on dim " + str(dimension +1))
    ax.set_xticklabels(ax.get_xticklabels(), rotation = 45, ha = 'right')
    ...
    ax.set_title("Normalized extended simplex sink counts per mtype on dim " + str(dimension +1))
    ax.set_xticklabels(ax.get_xticklabels(), rotation = 45, ha = 'right')
    ...
    ax.set_title("Normalized extended simplex end counts per mtype on dim " + str(dimension +1))
    ax.set_xticklabels(ax.get_xticklabels(), rotation = 45, ha = 'right')
